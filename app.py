...
st.set_page_config(
    page_title="Medical Image Analysis Platform by Euron ",
    page_icon="🏥",
    layout="wide"
)
...
# # Function to load CSS from the "assets" directory
...
selected_tab = st.radio("Select a section:", ["Image Upload & Analysis", "Collaboration", "Report Q&A", "Reports"])

# with tab1:
if selected_tab == "Image Upload & Analysis":
    # File uploader
